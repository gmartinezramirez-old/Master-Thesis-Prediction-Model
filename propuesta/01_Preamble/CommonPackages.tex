...
% Language support for 'spanish' (alternative 'ngerman' or 'french' for example)
...
\tikzset{
     block/.style={rectangle, draw, text width=7em,text centered, rounded corners, minimum height=3em},
     arrow/.style={-{Stealth[]}}
     }
